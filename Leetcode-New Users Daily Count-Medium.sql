...
Select A.activity_date,COUNT(A.userid) From (Select [user_id] as userid,MIN(activity_date) as activity_date  From Traffic
Where activity='login'
)as A 
Where Datediff(DAY,A.activity_date,'20190630')<=90
