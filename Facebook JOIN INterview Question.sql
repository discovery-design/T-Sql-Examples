 ...
 */
 ...
 --Soruda Yönetim kurulu baþkanýnýn bazý ürün kategorilerinin hiç satmadýðýný,
 --ve bunlarýn stoktan silinebileceðini düþündüðünü belirtiyor.
 --hiç satmayan ürün kategorilerinin yüzdesini hesaplayan bir sorgu yazmamýz isteniyor.



 Select COUNT(*)/(Select Count(*) From product_classes ) From Products P
 Left Join Sales S On S.product_id=P.product_id
 Inner Join product_classes PS on PS.product_class_id=P.product_class_id
